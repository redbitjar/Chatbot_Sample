...
import app.kakao.json_data.make_outputs as outputs
import app.kakao.json_data.sample as s

outputs.mes_data_parser(s.res_simple_text_mes, outputs.make_def_mes_plan_sts)
outputs.mes_data_parser(s.res_kakao_text_mes, outputs.make_def_mes_plan_sts)
outputs.mes_data_parser(s.res_def_mes_plan_sts, outputs.make_def_mes_plan_sts)
